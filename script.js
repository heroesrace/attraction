window.onload = function() {
    ...
    .then(buffer => {
        ...
        const cryptoPercentage = ((cryptoTotal / 1075000) * 100).toFixed(0);
        ...
        document.getElementById('roobicPercentage').innerText = 'Team Target : 1.075.000$, So Still Missing: ' + roobicPercentage + '$';
    })
